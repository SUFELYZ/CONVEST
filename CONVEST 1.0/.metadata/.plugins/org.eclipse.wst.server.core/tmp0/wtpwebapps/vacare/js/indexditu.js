...
var geoCoordMap = {
	    ...
	    '爱尔兰': [-8.137613,53.164314],
	    '澳大利亚':[133.650954,-25.273091],
	    '比利时': [4.380824,50.930023],
	    '德国':[10.451932,51.138829],
	    '法国':[1.011601,47.570368],
	    '美国':[-101.40513,39.867501],
	    '南非':[24.218418,-30.834487],
	    '印度':[78.921486,20.669189]
	};
    ...
                    links: [
                    {source: '爱尔兰',target: '上海'},
                    {source: '爱尔兰',target: '北京'},
                    {source: '爱尔兰',target: '宁夏'},
                    {source: '爱尔兰',target: '山东'},
                    {source: '爱尔兰',target: '广东'},
                    {source: '爱尔兰',target: '湖北'},
                	{source:'爱尔兰',target:'福建'},
                    {source:'爱尔兰',target:'贵州'},
                    {source:'爱尔兰',target:'辽宁'},
                    ],
                    roam: true,
