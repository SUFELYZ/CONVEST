       ...
       <div id="content">
        <div class="container">
          <div id="error-page" class="col-md-8 mx-auto text-center">
            <div class="box">
              <p class="text-center"><a href="首页.jsp"><img src="img/logo.png" alt="Obaju template"></a></p>
              <h3>抱歉-页面开小差了，请稍后再试</h3>
              <h4 class="text-muted">Error 404 - Page not found</h4>
              <p class="buttons"><a href="首页.jsp" class="btn btn-template-outlined"><i class="fa fa-home"></i>返回首页</a></p>
            </div>
          </div>
        </div>
      </div>
