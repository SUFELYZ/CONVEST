 ...
 * Generated at: 2021-01-06 02:06:51 UTC
...
public final class 高管信息_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    windowWidth:800,\r\n");
      out.write("                    windowHeight:1000,\r\n");
      out.write("                    defaultLinkDistance:100\r\n");
      out.write("                }\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\" id=\"template1\"><button type=\"button\" class=\"btn btn-template-main\"><i class=\"fa fa-tags\" ></i>中国平安</button></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t    <span class=\"input-group-btn\" id=\"template2\"><button type=\"button\" class=\"btn btn-template-main\"><i class=\"fa fa-tags\" ></i>方正科技</button></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t    <span class=\"input-group-btn\" id=\"template3\"><button type=\"button\" class=\"btn btn-template-main\"><i class=\"fa fa-tags\" ></i>古井贡酒</button></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t    <span class=\"input-group-btn\" id=\"template4\"><button type=\"button\" class=\"btn btn-template-main\"><i class=\"fa fa-tags\" ></i>芒果超媒</button></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("  \t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t  $('body').on('click', '#template1', function () {  \r\n");
      out.write("\t      \r\n");
      out.write("\t\t\t$(\"#svg1\").empty();\r\n");
      out.write("\t\r\n");
      out.write("       \r\n");
      out.write("       d3.json(\"中国平安.json\").then(function(dataJson){\r\n");
      out.write("        \t\r\n");
      out.write("            //GroupExplorer constructing function\r\n");
      out.write("            //this is one way to create a javascript object\r\n");
      out.write("            function GroupExplorer(data){\r\n");
      ...
      out.write("                var defaultConfig = {\r\n");
      out.write("                    data:{\"nodes\":[],\"links\":[]},//critical data set\r\n");
      out.write("                    windowWidth:500,\r\n");
      out.write("                    windowHeight:500,\r\n");
      out.write("                    defaultLinkDistance:30\r\n");
      out.write("                }\r\n");
      out.write("                //because the initial \"data\" is null,\r\n");
      out.write("                //so you need use jquery syntax \"extend\" to merge the json data\r\n");
      out.write("                //below,merge \"data\" into \"defaultWindow\"\r\n");
      ...
      out.write("                //but first ,we need to get \"svg\"\r\n");
      out.write("                var svg = d3.select(\"svg\");\r\n");
      out.write("                svg.attr(\"width\",800);\r\n");
      out.write("                svg.attr(\"height\",1000);\r\n");
      out.write("\r\n");
      out.write("                defaultConfig.data.links.forEach(function(e){\r\n");
      out.write("                    if(typeof e.source==\"number\"&&typeof e.target==\"number\"){\r\n");
      out.write("                        var sourceNode = defaultConfig.data.nodes.filter(function(n){\r\n");
      ...
      out.write("                    .append(\"svg:marker\")\r\n");
      out.write("                    .attr(\"id\", \"marker\")\r\n");
      out.write("                    .attr('viewBox', '10 10 10 10')\r\n");
      out.write("                    .attr(\"refX\", 20)\r\n");
      out.write("                    .attr(\"refY\",0)\r\n");
      out.write("                    .attr('markerWidth', 10)\r\n");
      out.write("                    .attr('markerHeight', 10)\r\n");
      ...
      out.write("        })\r\n");
      out.write("        });\r\n");
      out.write("\t  $('body').on('click', '#template2', function () {  \r\n");
      out.write("\t      \r\n");
      out.write("\t\t\t$(\"#svg1\").empty();\r\n");
      out.write("\t\r\n");
      out.write("     \r\n");
      out.write("     d3.json(\"方正科技.json\").then(function(dataJson){\r\n");
      out.write("      \t\r\n");
      out.write("          //GroupExplorer constructing function\r\n");
      out.write("          //this is one way to create a javascript object\r\n");
      out.write("          function GroupExplorer(data){\r\n");
      ...
      out.write("      })\r\n");
      out.write("      });\r\n");
      out.write("\t  $('body').on('click', '#template3', function () {  \r\n");
      out.write("\t      \r\n");
      out.write("\t\t\t$(\"#svg1\").empty();\r\n");
      out.write("\t\r\n");
      out.write("     \r\n");
      out.write("     d3.json(\"古井贡酒.json\").then(function(dataJson){\r\n");
      out.write("      \t\r\n");
      out.write("          //GroupExplorer constructing function\r\n");
      out.write("          //this is one way to create a javascript object\r\n");
      out.write("          function GroupExplorer(data){\r\n");
      ...
      out.write("      })\r\n");
      out.write("      });\r\n");
      out.write("\t  $('body').on('click', '#template4', function () {  \r\n");
      out.write("\t      \r\n");
      out.write("\t\t\t$(\"#svg1\").empty();\r\n");
      out.write("\t\r\n");
      out.write("     \r\n");
      out.write("     d3.json(\"芒果超媒.json\").then(function(dataJson){\r\n");
      out.write("      \t\r\n");
      out.write("          //GroupExplorer constructing function\r\n");
      out.write("          //this is one way to create a javascript object\r\n");
      out.write("          function GroupExplorer(data){\r\n");
      ...
      out.write("                  windowWidth:800,\r\n");
      out.write("                  windowHeight:1000,\r\n");
      out.write("                  defaultLinkDistance:120\r\n");
      out.write("              }\r\n");
      out.write("              //because the initial \"data\" is null,\r\n");
      out.write("              //so you need use jquery syntax \"extend\" to merge the json data\r\n");
      out.write("              //below,merge \"data\" into \"defaultWindow\"\r\n");
